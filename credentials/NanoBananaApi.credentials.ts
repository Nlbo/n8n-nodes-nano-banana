	...
	properties: INodeProperties[] = [
		{
			...
			default: 'official',
			description: '💡 Want more n8n tutorials and VIP nodes? Follow WeChat Official Account!',
		},
		{
		...
		},
		{
			...
			description: 'Gemini Native uses official API request structure with Base URL replaced; OpenAI Compatible uses Chat Completions API',
		},
	];
}
